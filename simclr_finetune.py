...
torch.save(model.state_dict(), os.path.join(args.checkpoint_dir, 'simiclr_fine_tune.path'))
print("Saved checkpoint to {os.path.join(args.checkpoint_dir, 'simiclr_fine_tune.path'}}")